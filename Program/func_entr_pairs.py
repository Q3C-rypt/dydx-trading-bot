...
def open_positions(client):
    ...
    Store trades for managing later on exit func
    """
    ...
    # Initialize container for BotAganet results
    bot_agents = []
        ...
        if len(series_1) > 0 and len(series_1) == len(series_2):
            ...
            if abs(z_score) >= ZSCORE_THRESH:
                ...
                if not is_base_open and not is_quote_open:
                    ...
                    # Get accepptable price in string format with correct number of decimals
                    ...
                    # Get size
                    base_quantity = 1 / base_price * USD_PER_TRADE #If i wanna trade different capital, change USD_PER_TRADE
                    ...
                    # If checks passs, place the trade babyy
